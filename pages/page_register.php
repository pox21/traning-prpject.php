                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 ml-auto mr-auto">
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    <?=isset($_SESSION['user_exist']) ?
                                        "<div class='alert alert-danger text-dark' role='alert'>
                                         <strong>Уведомление!</strong> " . $_SESSION['user_exist'] .
                                        "</div>"
                                    : ''?>
                                    ...
                                    <form id="js-login" novalidate="" action="" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" id="userpassword" class="form-control" placeholder="" required name="pass">
                                            <div class="invalid-feedback">Заполните поле.</div>
                                        </div>
